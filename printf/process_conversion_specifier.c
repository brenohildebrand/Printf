...
/*   Updated: 2023/09/18 16:11:50 by bhildebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	process_conversion_specifier(
	...
	if (specs->conversion_specifier == 'c')
		return (convert_c(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 's')
		return (convert_s(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 'p')
		return (convert_p(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 'd')
		return (convert_d(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 'i')
		return (convert_i(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 'u')
		return (convert_u(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 'x')
		return (convert_x(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == 'X')
		return (convert_upper_x(args, conversion_buffer, specs));
	else if (specs->conversion_specifier == '%')
		return (convert_percentage(args, conversion_buffer, specs));
	else
		return (ERROR);
}
